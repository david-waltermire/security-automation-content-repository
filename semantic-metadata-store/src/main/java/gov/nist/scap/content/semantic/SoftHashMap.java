...
// Code adapted from: http://www.roseindia.net/javatutorials/implementing_softreference_based_hashmap.shtml
// CHECKSTYLE:OFF
public class SoftHashMap<K,V> extends AbstractMap<K,V> {
    ...
    public V put(K key, V value) {
      ...
      SoftReference<V> sr = hash.put(key, new SoftValue<V>(value, key, queue));
      if( sr != null ) {
          return sr.get();
      }
      return null;
